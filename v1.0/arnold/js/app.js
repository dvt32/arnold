// TO-DO:
// [X] Fix Arnold image size
// [X] Make choppa a bit smaller
// [X] Fix Arnold jump size
// [X] Implement smooth enemy appearance
// [X] Implement more rows
// [X] Implement enemy collision
// [X] Clean up Enemy class code
// [X] Fix coordinates to make it work with more rows
// [X] Clean up Choppa class code
// [X] Clean up Player class code


// [] Release v1.0 and set updates



// [] v1.1: Implement enemy sides
// [] v1.1: Make screen wider (for move movement flexibility)
...
Player.prototype.checkCollisions = function() {
    ...
    if (this.y <= 50 && this.x <= 250 && this.x >= 150) {
