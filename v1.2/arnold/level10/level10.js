...
startNextLevel = function() {
    location.href = "../level11/index.html";
};
...
var Engine = (function(global) {
    ...
    Resources.load([
        ...
        '../images/arnold.png',
        '../images/choppa.png',
        '../images/portal_blue.png',
        '../images/portal_red.png'
    ]);
...
Player.prototype.checkCollisions = function() {
    ...
    // Arnold went through the blue portal!
    else if (player.x === 705 && player.y === 620) {
        this.x = 200;
        this.y = 60;
    }
    // Arnold went through the red portal!
    else if (player.x === 99 && player.y === 60) {
        this.x = 604;
        this.y = 620;
    }
...
var Portal = function(x, y, color) {
    this.sprite = (color === 'blue') ? '../images/portal_blue.png' : '../images/portal_red.png';
    this.x = x;
    this.y = y;
}
...
var allPortals = [
    new Portal(730, 720, 'blue'),
    new Portal(130, 140, 'red')
];